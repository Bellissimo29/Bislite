...
$(".works-box").slick({
  ...
  autoplaySpeed: 1600,
  nextArrow:
    '<button type="button" class="slick-next work-right"><img src="img/arrow-right.svg" alt="right"></button>',
  prevArrow:
    '<button type="button" class="slick-next work-left"><img src="img/arrow-left.svg" alt="left"></button>',
  responsive: [
    {
      breakpoint: 900,
      settings: {
